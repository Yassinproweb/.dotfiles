...
# html
alias vml="vi index.html"

# js
alias vjs="vi main.js"

# golang
alias vgo="vi main.go"
alias rgo="go run main.go"
alias air="~/go/bin/air -log.time true"

# rust
alias vrs="vi main.rs"
alias rsc="rustc main.rs && ./main"
...
alias vvi="vi ~/.config/nvim/lua/config/lazy.lua"
...
# function for a initiating a new go project
function golang() {
